    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade in active" id="2a">
           <div class="panel panel-default">
                ...
                <form action="{{ url('dental_history') }}" method="POST" class="form-horizontal"  name = "medicalHistoryForm" novalidate>
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="chief-complaint" class="col-xs-3 control-label">Chief Complaint</label>

                        <div class="col-xs-8">
                            <input type="text" name="cp_no" ng-model="patient.cp_no" id="chief-complaint" class="form-control">
                        </div>
                    </div>
                    <?php 
                    ...
                    <?php  foreach($dental_histories as $dental_history_key => $dental_history):?>
                        <label class="btn btn-default">
                            <input type="hidden" name="dental_history[]" ng-model="patient.dental_history[<?php echo $dental_history->id;?>]" id="<?php echo $dental_history->id;?>" value="0">
                            <input type="checkbox" name="dental_history[]" ng-model="patient.dental_history[<?php echo $dental_history->id;?>]" id="<?php echo $dental_history->id;?>" value=<?php echo $dental_history->id;?>><?php echo $dental_history->name?>
        ...
        <div class="tab-pane fade" id="3a">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form name="medicalHistoryForm" ng-submit="medical_history_submit()">
                    {{--  <form action="{{ url('dental_history') }}" method="POST" class="form-horizontal"  name = "medicalHistoryForm" novalidate>  --}}
                        {{ csrf_field() }}
                        ...
                        ?>
                        <div class="form-group btn-group-vertical col-xs-12" data-toggle="buttons">
                        <?php  foreach($medical_histories as $medical_history){?>
                            <label class="btn btn-default">
                                <input type="checkbox" name="patient[medical_history]" id=<?php echo $medical_history->id;?> value=<?php echo $medical_history->id;?>><?php echo $medical_history->name?>
                            </label>
                        <?php }?>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <i class="fa fa-circle-o-notch fa-spin" style="font-size:24px"></i> Save
                                </button>
                            </div>
                        </div>
                        <div >
                            <p>Enter your Name: <input type = "text" ng-model = "name"></p>
                            <p>Hello @{{patient_history}}!</p>
                        </div> 
                    </form>
                </div>
            </div> 
